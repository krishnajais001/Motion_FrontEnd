                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col items-end">
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-30">REG Protocol: 991</span>
                                <div className="h-2 w-12 bg-black/5 dark:bg-white/10 mt-1 overflow-hidden">
                                     <div className="h-full bg-black dark:bg-white animate-[progress_2s_infinite_linear]" style={{ width: '65%' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="border-4 border-black dark:border-white p-10 bg-black text-white dark:bg-white dark:text-black">
                            <div className="flex items-center justify-between mb-8 border-b border-white/20 dark:border-black/20 pb-4">
                                <div className="space-y-1">
                                    <h2 className="text-2xl font-black uppercase tracking-tighter">Registration Protocol</h2>
                                    <p className="text-[11px] font-medium opacity-50">Establish a new presence within the system.</p>
                                </div>
                            ...
                            <form onSubmit={handleSignup} className="space-y-6">
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-6 pt-6">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="group flex-1 bg-white text-black dark:bg-black dark:text-white border-2 border-transparent p-5 text-sm font-black uppercase tracking-[0.4em] flex items-center justify-center gap-3 hover:bg-gray-200 dark:hover:bg-gray-800 transition-all disabled:opacity-50"
                                    >
